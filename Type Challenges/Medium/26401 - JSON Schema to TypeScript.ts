...
// type
// enum (tuple) exists then it's a Union
// properties are part of object and are optional by default
// only readonly if required
// array has an items field
...
> = T["enum"] extends Types[keyof Types][]
	? T["enum"][number]
