type BuildAnyArray<N extends number, T extends unknown[] = []> = T["length"] extends N
	? T
	: BuildAnyArray<N, [...T, any]>;
type DayCounter<S extends number, E extends number> = BuildAnyArray<E> extends [
	infer X,
	...infer Rest,
]
	? Rest["length"] extends S
		? S | E
		: E | DayCounter<S, Rest["length"]>
	: S;
